    ...
    <v-stepper v-model="step" vertical>
                ...
                <div class="en-merchantForm-title">
                  <v-card elevation="0" class="pa-5 mb-5 border">
                    ...
                    (v) => /.+@.+\..+/.test(v) || 'E-mail must be valid',
                            ...
                            <div
                              v-if="merchantData.image"
                              class="en-merchantForm-main-left-form-row"
                            >
                              <div class="row">
                                <img
                                  :key="merchantData.image"
                            ...
                            >
                              <label for="image-upload" class="custom-file-upload">
                                <v-icon style="color: white;">mdi-upload</v-icon>Image Upload
                              </label>
                              <input
                                id="image-upload"
                                ref="imageUpload"
                            ...
                            <v-card class="p-3">
                              ...
                              <v-card-text>
                                ...
                                <div
                                  v-for="(payment,index) in merchantData.payments"
                                  :key="'p'+index"
                                >
                                  ...
                                  <v-btn
                                    color="error"
                                    @click="$delete(merchantData.payments, index)"
                                  >remove</v-btn>
                                  <hr />
                                </div>
                              </v-card-text>
      ...
      <v-stepper-content step="2">
        ...
        <v-btn
          ...
          color="#dc1f29"
          dark
          @click="contactPersonFormValidated"
        >Update</v-btn>
